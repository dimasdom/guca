...
function App() {
    return (
        <MainDiv height={window.innerHeight +30} width={window.innerWidth +30}>
            <h1 className="text-center border-bottom p-3 Guca text-white start">GuCa</h1>
            <div className="container plotcontainer text-white ">
                <div className="row flex">
                    ...
                    <div className="col-md-6 col-sm-12 mt-5">
                        <div className="row Info">
                            ...
                            <div className="col"><p>Genres:<br/>HipHop/Rap</p></div>
                        </div>
                        <div>
                            <p>Featured Albums</p>
            ...
            <div className="row border-top mt-auto text-white ">
                <div className="col-2 mt-3 ml-5"><img className="img-fluid plotkosyakimg rounded" src={GucaPic}/>       Jirniy Kosyak</div>
                <div className="col-9"><figure>
                    <figcaption className="ml-5 mt-3"></figcaption>
